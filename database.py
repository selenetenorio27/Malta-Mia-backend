...
def agregar_cervezas():
    cerveza1 = Cerveza(nombre='Dark Lager', marca='Principia',porcentaje_alcohol=4.0, estilo='lager', ibus=22, color='obscura', sabor='caramel_and_toasted', ingrediente_adicional='coffee')
    ...
    cerveza3 = Cerveza(nombre='Extrasolar', marca='Principia',porcentaje_alcohol=6.5, estilo='ipa', ibus=30, color='clara_turbia', sabor='fruity', ingrediente_adicional='fruit')
    cerveza4 = Cerveza(nombre='Spectra', marca='Principia',porcentaje_alcohol=6.7, estilo='ipa', ibus=60, color='clara_dorada', sabor='citric', ingrediente_adicional='none')
    cerveza5 = Cerveza(nombre='Asimetria', marca='Principia',porcentaje_alcohol=5.5, estilo='stout', ibus=20, color='obscura', sabor='caramel_and_toasted', ingrediente_adicional='peanut_butter')
    ...
    cerveza8 = Cerveza(nombre='Bahia', marca='De la Costa',porcentaje_alcohol=3.8, estilo='lager', ibus=14, color='muy_clara', sabor='light_and_refreshing', ingrediente_adicional='none')
    cerveza9 = Cerveza(nombre='Harry Polanco', marca='Wendlandt',porcentaje_alcohol=5.5, estilo='red_ale', ibus=50, color='rojiza', sabor='caramel_and_toasted', ingrediente_adicional='none')
    ...
    cerveza11 = Cerveza(nombre='Foca parlante', marca='Wendlandt',porcentaje_alcohol=5.5, estilo='stout', ibus=38, color='obscura', sabor='toasted', ingrediente_adicional='coffee_and_chocolate')
    ...
    cerveza13 = Cerveza(nombre='Veraniega', marca='Wendlandt',porcentaje_alcohol=4.7, estilo='pale_ale', ibus=20, color='muy_clara', sabor='light_and_refreshing', ingrediente_adicional='none')
    ...
    cerveza17 = Cerveza(nombre='Lagrimas negras', marca='Ramuri',porcentaje_alcohol=10.0, estilo='imperial_cacao_stout', ibus=34, color='muy_obscura', sabor='toasted', ingrediente_adicional='chocolate')
    cerveza18 = Cerveza(nombre='Lagrimas de cacahuate', marca='Ramuri',porcentaje_alcohol=8.0, estilo='imperial_cacao_stout', ibus=38, color='muy_obscura', sabor='none', ingrediente_adicional='peanut_butter')
    cerveza19 = Cerveza(nombre='Odin', marca='Ramuri', porcentaje_alcohol=9.3, estilo='imperial_coffee_stout', ibus=74, color='muy_obscura', sabor='none', ingrediente_adicional='coffee')
    ...
    cerveza22 = Cerveza(nombre='Dakota Stout', marca='19 Norte',porcentaje_alcohol=7.8, estilo='stout', ibus=40, color='obscura', sabor='none', ingrediente_adicional='coffee_and_chocolate')
    ...
    cerveza27 = Cerveza(nombre='Amber Ale', marca='Xinampa',porcentaje_alcohol=5.5, estilo='amber_ale', ibus=40, color='clara', sabor='caramel_and_citric', ingrediente_adicional='none')
